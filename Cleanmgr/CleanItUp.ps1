...
@echo off
REM This script deletes all shadow copies
vssadmin Delete Shadows /ALL
@echo  Shadow Copies have been deleted
...
REM  Here are some options..
REM vssadmin Delete Shadows /For=VolumeSpec [/Oldest] [/Quiet]
REM vssadmin Delete Shadows /Shadow=ShadowID [/Quiet]
